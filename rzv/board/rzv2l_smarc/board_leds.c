...
/******************************************************************************************************************//**
 * @addtogroup BOARD_RZV2L_SMARC_LEDS
 *
 * @{
 *********************************************************************************************************************/
...
/** Array of Pmod LED to be used on bottom row of Pmod0. */
static const uint16_t g_bsp_prv_leds[] =
{
    (uint16_t) BSP_IO_PORT_43_PIN_02,  ///< LD1 : J1.8
    (uint16_t) BSP_IO_PORT_41_PIN_00,  ///< LD2 : J1.9
};
...
/** @} (end addtogroup BOARD_RZV2L_SMARC_LEDS) */
