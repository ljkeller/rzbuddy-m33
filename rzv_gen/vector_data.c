...
{ Default_Handler, /* IRQ:0 */
  ...
  gpt_capture_a_isr, /* IRQ:309 GPT7 CCMPA7 (GPT32E7.GTCCRA input capture/compare match) */
  gpt_capture_b_isr, /* IRQ:310 GPT7 CCMPB7 (GPT32E7.GTCCRB input capture/compare match) */
  ...
  gpt_counter_overflow_isr, /* IRQ:317 GPT7 OVF7 (GPT32E7.GTCNT overflow (GPT32E7.GTPR compare match)) */
