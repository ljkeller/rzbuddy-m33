...
{ Default_Handler, /* IRQ:0 */
  ...
  gpt_capture_a_isr, /* IRQ:270 GPT4 CCMPA4 (GPT32E4.GTCCRA input capture/compare match) */
  gpt_capture_b_isr, /* IRQ:271 GPT4 CCMPB4 (GPT32E4.GTCCRB input capture/compare match) */
  ...
  gpt_counter_overflow_isr, /* IRQ:278 GPT4 OVF4 (GPT32E4.GTCNT overflow (GPT32E4.GTPR compare match)) */
